...
leave_out_cell_types_options = [['NK cells'], ['NK cells', 'NKT cells']]
...
for deep_inject in deep_injects:
    for leave_out_cell_types in leave_out_cell_types_options:
        # Save right dir path
        ...
        adata_all = sc.read(
            os.path.expanduser(f'~/Documents/benchmarking_datasets/Immune_ALL_human_wo_villani_normalized_hvg.h5ad'))
