...
for deep_inject in deep_injects:
    for test_nr in test_nrs:
        if deep_inject:
            dir_path = os.path.expanduser(f'~/Documents/benchmarking_results/figure_6/scanvi/test_{test_nr}_deep_cond/')
        else:
            dir_path = os.path.expanduser(
                f'~/Documents/benchmarking_results/figure_6/scanvi/test_{test_nr}_first_cond/')
