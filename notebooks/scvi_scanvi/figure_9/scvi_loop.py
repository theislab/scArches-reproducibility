    ...
    for population in populations:
        if deep_inject:
            dir_path = os.path.expanduser(
                f'~/Documents/benchmarking_results/figure_9/{data}/scvi/population_{population}_deep_cond/')
        else:
            dir_path = os.path.expanduser(
                f'~/Documents/benchmarking_results/figure_9/{data}/scvi/population_{population}_first_cond/')
        ...
        if data == 'pancreas':
            ...
            if population == 1:
                adata_all = sc.read(
                    os.path.expanduser(f'~/Documents/benchmarking_datasets/pancreas_rare/pancrease_rare_1705.h5ad'))
            elif population == 2:
                adata_all = sc.read(
                    os.path.expanduser(f'~/Documents/benchmarking_datasets/pancreas_rare/pancrease_rare_3404.h5ad'))
            elif population == 3:
                adata_all = sc.read(
                    os.path.expanduser(f'~/Documents/benchmarking_datasets/pancreas_rare/pancrease_rare_5097.h5ad'))
            elif population == 4:
                adata_all = sc.read(
                    os.path.expanduser(f'~/Documents/benchmarking_datasets/pancreas_rare/pancrease_rare_7390.h5ad'))
            elif population == 5:
                adata_all = sc.read(
                    os.path.expanduser(f'~/Documents/benchmarking_datasets/pancreas_rare/pancrease_rare_10878.h5ad'))
        if data == 'pbmc':
        ...
        if data == 'pbmc':
            custom_pal = 4 * [color_pal[1]] + [color_pal[2]] + 11 * [color_pal[1]]
